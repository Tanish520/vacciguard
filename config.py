...
SLA_THRESHOLD_MS = int(os.getenv("VACCIGUARD_SLA_THRESHOLD_MS", "5000"))
...
METRICS_SUMMARY_INTERVAL = int(os.getenv("VACCIGUARD_METRICS_SUMMARY_INTERVAL", "100"))
METRICS_NAMESPACE = os.getenv("VACCIGUARD_METRICS_NAMESPACE", "VacciGuard/BaselinePipeline")

...
def build_pipeline_config_patch(
    *,
    ...
    cold_trigger_interval: str,
    watermark_delay: str,
    max_offsets_per_trigger: str | None = None,
    cold_max_offsets_per_trigger: str = "",
    redis_host: str,
    redis_port: str,
    redis_db: str,
) -> dict[str, object]:
    ...
    patch = {
        ...
        "data": {
            ...
            "COLD_TRIGGER_INTERVAL": cold_trigger_interval,
            "COLD_MAX_OFFSETS_PER_TRIGGER": cold_max_offsets_per_trigger,

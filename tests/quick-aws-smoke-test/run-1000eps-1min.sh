#!/usr/bin/env bash
# run-1000eps-1min.sh -- Replay 60,000 events at 1000 eps for 1 minute (S3-based)
set -euo pipefail
...
S3_KEY="workloads/smoke-test-1000eps/events.ndjson"
S3_URI="s3://${S3_BUCKET}/${S3_KEY}"
LOCAL_WORKLOAD_FILE="/tmp/workload-1000eps.ndjson"
...
echo "============================================================"
echo "  Quick Smoke Test: 1000 EPS / 1 Minute (S3-based)"
echo "============================================================"
